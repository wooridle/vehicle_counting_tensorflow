    ...
    with detection_graph.as_default():
        with tf.Session(graph=detection_graph) as sess:
            ...
            while (cap.isOpened()):
                ...
                cv2.putText(input_frame, "Detected Vehicles: " + str(total_passed_vehicle), (10, 35), font, 0.8,
                ...
                cv2.putText(input_frame, "LAST PASSED VEHICLE INFO", (11, 290), font, 0.5, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_SIMPLEX)
                cv2.putText(input_frame, "-Movement Direction: " + direction, (14, 302), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(input_frame, "-Speed(km/h): " + speed, (14, 312), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(input_frame, "-Color: " + color, (14, 322), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
                cv2.putText(input_frame, "-Vehicle Size/Type: " + size, (14, 332), font, 0.4, (255, 255, 255), 1,
                            cv2.FONT_HERSHEY_COMPLEX_SMALL)
